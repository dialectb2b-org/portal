...
@section('content')
        ...
        <header class="navbar">
            <div class="header container-fluid navbar-default d-flex align-items-center">
                ...
                <div class="header-right-btn">
                    <a href="{{ route('member.signUp') }}" class="btn btn-primary float-right ms-2">Signup as Guest </a>
    ...
    <section class="home2-content-main">
        <section class="container">
        <div class="row">
            <div class="col-md-5">
                <img src="{{ asset('assets/images/we-are-img.png') }}" alt="">
            </div>
            <div class="col-md-7 pt-2">
                <h1>We are</h1>
                <h2 class=" pt-4">Dialect  B2B...</h2>
                <p class=" pt-5">
                   Welcome to DialectB2B.com – Your Premier Online Platform for Sales and Procurement Excellence.
At DialectB2B.com, we understand the dynamic and competitive nature of today's business landscape. Our mission is to empower sales and procurement professionals across various industries and businesses of all sizes. We believe that efficiency, transparency, and innovation are the cornerstones of success in the modern world of commerce.
Our comprehensive suite of solutions is designed to help professionals like you thrive:
Supplier Database: Our extensive directory of suppliers spans various categories and industries. Sales professionals can leverage this resource to identify potential customers or partners with ease. This, in turn, expands their outreach and enhances the likelihood of discovering lucrative business opportunities.
        ...
        <section class="mt-5">
            ...
            <div class="d-flex">
                <div class="sales-boxes d-flex flex-column justify-content-center align-items-center">
                    ...
                    <p class="mt-2">Digital Channel to generate Qualified Leads</p>
                </div>
