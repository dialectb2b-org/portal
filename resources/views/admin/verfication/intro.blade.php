            ...
            <div class="row how-it-works">
                ...
                <div class="d-flex flex-wrap position-relative mb-5">
                    ...
                    <div class="how-process-main d-flex flex-column align-items-center ">
                        ...
                        <h3 class="mt-3">Subscribe to the<br>
                            Standard Package</h3>
                        <p class="mt-2">Begin the subscription to the Standard Package via the verification process on the Admin’s Home Page, using the company account. 
                            Please note that transactions from individual bank accounts will not be considered for verification purposes.
