                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-group position-relative">
                                                            ...
                                                            <input id="admin-email" type="text" name="admin_email" value="{{ old('admin_email') ?? $admin->email ?? '' }}" placeholder="Email" class="form-control @error('admin_email') red-border @enderror" readonly>
