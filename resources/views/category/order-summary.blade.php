...
@section('content')
  ...
  <section class="container-fluid pleft-77">
      <form action="{{ route('category-purchase.makePayment') }}" method="post">
          @csrf
        <div class="px-4 py-3">
            ...
            <div class="sub-plans-main">
                <div class="row">
                    <div class="col-md-8 order-summ-content">
                        <p>By proceeding with this order, you're confirming acceptance of our terms of service. Your payment method will be securely stored and updated for continuous service.
                        Please refer to our User Agreement on the homepage for details<br> on cancellation and refunds. Kindly note that prices are subject to change.</p>
                        <div class="mt-3">
                            <div class="row">
                    ...
                    <div class="col-md-4 order-summ-content">
                        <div class="mt-5">
                            ...
                            <div class="d-flex align-items-center justify-content-between content-summ mt-2">
                                {{ $cartItem->subcategory->name ?? '' }}
                                <span class="d-flex align-items-center">
                                    ${{ $cartItem->subcategory->price ?? '' }}
                                    <a href="#" class="ml-15"><img src="{{ asset('assets/images/trash-can-outline.svg') }}" alt=""></a>
                                </span>
                            </div>
                            @php $total+= $cartItem->subcategory->price @endphp
                            @endforeach
                            </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-4">
                            <div class="plan-off d-flex">
                                ...
                                <input type="checkbox" name="payment_period" id="aa3" class="add-page-check"  value="12">
                        ...
                        <div class="total-amount mt-4">
                            ...
                            <div class="d-flex align-items-center justify-content-between sub-total">
                                Sub Total
                                <span class="rate-total-val">${{ number_format($total,2) }}</span>
                            </div>
                            <div class="d-flex align-items-center justify-content-between sub-total">
                                Discount
                            ...
                            <div class="d-flex align-items-center justify-content-between total">
                                Sub Total
                                <span class="sub-total-val">${{ number_format($total,2) }}</span>
                            </div>
                        </div>
                         <div class="mt-4">
                            <p>Starting {{ date('d F, Y') }}, you will be charged $<span id="payment-amount"></span> <span id="payment-interval"></span> monthly for each selected category plus applicable taxes..<br>
                ...
                <div class="d-flex justify-content-between align-items-center mt-5">
                    <div class="form-group proceed-btn">
                        <a href="{{ route('category-purchase.index') }}" class="btn btn-secondary" >Back</a>
                    </div>
                    <div class="form-group proceed-btn">
