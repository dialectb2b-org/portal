    ...
    <div class="container-fluid p-0" style="background-color:#21295c">
        ...
        <section class="container mission-content-main pt-4">
            <div class="sub-plans-head">
                <h1 class="text-start"><a href="{{ url('/') }}" class="back-btn"></a>Privacy Policy</h1>
                <div class="row  p-4">
                       <!-- Tabs nav -->
                    ...
                    <div class="col-md-12">
                        <!-- Tabs content -->
                        <div>
                            <div class="bg-white show active p-5" id="v-pills-user-privacy-protection" role="tabpanel" aria-labelledby="v-pills-user-privacy-protection-tab">
