...
@section('content')
    ...
    <div class="container-fluid p-0 login-bg2">
        ...
        <span class="down-arrow d-flex"></span>
    </div>
    ...
    <section class="home2-content-main">
        ...
        <div class="row">
            ...
            <div class="col-md-7 pt-2">
                ...
                <p class=" pt-5">
                    We combine skill, honesty, a results-driven culture, and a rigorous commitment to an Agile environment to ensure that your project is completed on time and to the highest quality possible. We help businesses with product design, development and technology acceleration.
                </p>
