                ...
                <div class="bid-inbox">
                    ...
                    <div class="tabcontent3" id="sent" style="display: block;">
                        <div id="send-list" class="list-group">
                            ...
                            <a href="{{ route('procurement.reviewList.received', ['ref' => Crypt::encryptString($enquiry->reference_no)]) }}" class="list-group-item list-group-item-action flex-column align-items-start enquiry_item received-bg-color">
