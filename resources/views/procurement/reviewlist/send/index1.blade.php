                        ...
                        var content = `<a id="enquiry-${enquiry.id}" href="#" data-id="${enquiry.id}" class="list-group-item list-group-item-action flex-column align-items-start enquiry_item sent-bg-color">
                                <div class="list-item-inner blue-border">
                                    ...
                                    <div class="d-flex w-100 justify-content-between">
                                        ...
                                        <small class="bid-count d-flex align-items-center justify-content-center">${enquiry.selected_count}</small>
                                    </div>
                                </div>
                            </a>`;
        ...
        function openEnquiry(id){
            ...
            axios.post(fetchEnquiryAction, {id:id})
                 .then((response) => {
                    ...
                    var suggestionsCount = enquiry.suggestions ? enquiry.suggestions.length : 0;
                            
                    $('#open-count').text(openFaqCount);
                    $('#closed-count').text(closedFaqCount);
                    $('#pending-count').text(suggestionsCount);
