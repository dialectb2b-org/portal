                        ...
                        <div class="col-md-3 pr-0">
                            <div class="profile-stting-sec1">
                                <div class="d-flex align-items-center justify-content-end">
                                    <a href="{{ route('procurement.editProfile') }}" class="team-edit"><img src="{{ asset('assets/images/team-edit-ico.svg') }}"></a>
                                </div>
                                <div class="d-flex">
                                    ...
                                    <div class="sale-prof-name">
                                        ...
                                        <div class="form-group">
                                            <input type="submit" value="Reset Password" class="btn btn-third"  onclick="window.location.href = 'forgot-password.html'">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="profile-stting-sec3">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @else
                                        <input type="submit" value="Cancel" class="btn btn-third" onclick="window.location.href = 'subscription-plans.html'" >
                                        @endif
                                    </div>
                                </div>
                                <div class="sale-prof-detail">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            {{ $package->plan_validity == null ? 'NA' : $package->plan_validity }}
                                        </div>
                                    </div>
                                    <div class="sale-prof-detail">
                                        @if($company->current_plan == 2)
                                        <a href="#" class="mt-4 d-flex">View Details</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
