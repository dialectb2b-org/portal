                        ...
                        <table id="myTable" class="table team-settings-row">
                            ...
                            <tbody>
                                ...
                                <tr id="editable-{{ $member->id }}" class="non-editing">
                                    ...
                                    <td class="text-center text-{{ $member->status == 1 ? 'success' : 'danger' }}" id="enable-non-edit-{{ $member->id }}">@if($member->password != ''){{ $member->status == 1 ? 'Enabled' : 'Disabled' }}@else{{ 'Activation Pending' }}@endif</td>
                ...
                <div class="modal-body row">
                    ...
                    <div class="modal-footer model-footer-padd">
                        <div class="d-flex justify-content-end">
                            ...
                            <div class="form-group proceed-btn">
                                <input id="save-member" type="button" value="Sent" class="btn btn-secondary">
                            </div>
                        </div>
                    </div>
                </form>    
