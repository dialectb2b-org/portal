        ...
        <div class="header-signup container-fluid navbar-default d-flex">
            <div class="container">
                <div class="logo">
                    ...
                    <a href="{{ route('procurement.dashboard') }}" class="btn btn-primary draft" style="float: right;">Back to Home</a>
                </div>
            </div>
        </div>
    </header>
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <span class="category-selected d-flex align-items-center justify-content-between">{{ $enquiry->sub_category->name ?? ''}}</span>
                                            <input id="enquiry_id" name="enquiry_id" type="hidden" value="{{ $enquiry->id }}" />
                                        </div>
                                        <div class="col-md-12">
...
<script>
    ...
    jQuery(document).ready(function($) {
        ...
        $(document).on('click', '.subcategory', function (e) {
            ...
            var action = "{{ route('procurement.quote.updateCategory') }}";
            var data = { 'id' : activityId, 'enquiry_id' : enquiry_id }
            axios.post(action,data)
            .then((response) => {
                // Handle success response
                ...
                if(response.data.status === true){
                    ...
                    window.location.href = '/procurement/quote/compose/'+id;
                }
                else{
