    ...
    <section class="container-fluid pleft-77">
        <div class="px-4 py-3">
            <div class="sub-plans-head">
                <h2 class="text-dark"><a href="{{ route('profile.index') }}" class="back-btn"></a>Edit Company Profile</h2>
            </div>
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="profile-container">
                                <div id="profile-image">
                                    <img src="{{ asset($company->logo)  }}" alt="Profile Image">
    ...
    $(document).ready(function() {
        ...
        function updateProfileImage(input) {
            ...
            if (file) {
                ...
                const apiUrl = '/company-profile/update-logo';
