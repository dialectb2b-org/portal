                    ...
                    <section class="reg-content-sec">
                        <div class="signup-fields d-flex justify-content-center">
                            <div class="email-otp">
                                ...
                                <form id="otp-form" action="{{ route('member.checkOtp') }}" method="post" class="digit-group d-flex justify-content-center " data-group-name="digits" data-autosubmit="false" autocomplete="off">
                                    @csrf
...
<script>
    ...
    $(document).ready(function() {
        ...
        var resend_url = "{{ route('member.resendOtp') }}";
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status === true){
                        ...
                        window.location.href = "{{ route('member.declaration') }}";
                    }
                },
                error: function(xhr, status, error) {
