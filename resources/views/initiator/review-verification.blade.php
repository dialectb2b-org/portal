                        ...
                        <div class="signup-fields">
                            <div class="row mt-4">
                                <div class="col-md-12 varify-heading">
                                    <h2>That's Great! Thank you for updating your company details.</h2>
                                    <div class="d-flex justify-content-center">
                                        <p class="text-center">
                                       Your company registration approval process is currently under review.<br>
                                        If you haven't received any response from our end within 48 hours, please contact our customer care through the chat box.
                                        </p>
                                    </div>
