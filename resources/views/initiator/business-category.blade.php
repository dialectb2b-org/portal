                        ...
                        <div class="signup-fields">
                            <div class="row mb-3">
                                <div class="col-md-12 d-flex justify-content-between justify-content-center">
                                 ...
                                 <p class="mt-2"> During registration, you can choose up to a maximum of 4 privileged business categories. Once selected, these categories are permanent and cannot be added or deleted. However, if you wish to add more categories after registration, you can easily subscribe them separately.</p>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="airconditioning subcategory-section">
                                        ...
                                        <input type="hidden" id="current-category-id" value="" />
        ...
        $(document).on('click', '.category', function(e){
            ...
            .then((response) => {
                ...
                if(response.data.status === true){
                    ...
                    $('#current-category-id').val(response.data.category.id);
                    if(response.data.data.length){
                        $.each(response.data.data, function(key, val) {
                            var li = `<li id="sel`+val.id+`" class=""><a href="#" class="subcategory" data-id="`+val.id+`">`+val.name+`</a></li>`;
            ...
            if(response.data.status === true){
                ...
                if(response.data.data.length){
                    ...
                    if(response.data.data.length < 4){
                        var add_data = `<li class="text-center" data-dismiss="modal"><h3>+ Add Business Category</h3></li>`;
                    }
                    $('#selected-subcategory').append(add_data);
                }
                else{
                    var li = `<li class="text-center"><h3>No Data Found!</h3></li><li class="text-center" data-dismiss="modal"><h3>+ Add Business Category</h3></li>`;
                    $('#selected-subcategory').append(li);
                }
            }
            else{
