                ...
                <section class="reg-content-main">
                    ...
                    <section class="reg-content-sec">
                        ...
                        @if($checklist)
                            ...
                            @if($checklist->company_name == 0 || $checklist->country == 0 || $checklist->document_type == 0 || $checklist->document_no == 0 || $checklist->expiry_date == 0 || $checklist->document == 0 || $checklist->declaration == 0 || $checklist->declaration_seal == 0 || $checklist->declaration_signature == 0)
                                
                            <div class="alert alert-warning" role="alert">
                               <h4>Make following corrections and resubmit your application.</h4>
                               <ul class="m-3">
                                   @if($checklist->company_name == 0)
                                        <li>Company name doesn't match CR.</li>
                                   @endif
                                   @if($checklist->country == 0)
                                        <li>Registration country is inaccurate.</li>
                                   @endif
                                   @if($checklist->document_type == 0)
                                        <li>Submitted document doesn't confirmed as CR.</li>
                                   @endif
                                   @if($checklist->document_no == 0)
                                        <li>Document number doesn't match CR.</li>
                                   @endif
                                   @if($checklist->expiry_date == 0)
                                        <li>Document expiry doesn't match CR.</li>
                                   @endif
                                   @if($checklist->document == 0)
                                        <li>Uploaded CR document not valid.</li>
                                   @endif
                                   @if($checklist->declaration == 0)
                                        <li>Uploaded declaration not valid.</li>
                                   @endif
                                   @if($checklist->declaration_seal == 0)
                                        <li>Check the company seal on the declaration.</li>
                                   @endif
                                   @if($checklist->declaration_signature == 0)
                                        <li>Ensure a clear signature on the declaration.</li>
                                   @endif
                               </ul>
                            </div>
                           @endif
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group position-relative">
                                                ...
                                                <input id="name" type="text" name="name" class="form-control " value="{{ $company->name }}" placeholder="Company Name" maxlength="100">
                                                <div class="invalid-msg2"> </div>
                                                <p class="{{ $checklist && $checklist->company_name == 0 ? 'alert alert-warning p-1 mt-2' : '' }}">
                                                    <small>{{ $checklist && $checklist->company_name == 0 ? "Company name doesn't match CR." : '' }}</small> 
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group position-relative">
                                                ...
                                                <input id="address" type="text" name="address" class="form-control" value="{{ $company->address }}" placeholder="Address" maxlength="100">
                                                <div class="invalid-msg2"> </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group position-relative">
                                                <label>Street <span class="mandatory">*</span></label>
                                                <input id="street" type="text" name="street" class="form-control" value="{{ $company->street }}" placeholder="Street No" maxlength="100">
                                                <div class="invalid-msg2"> </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group position-relative">
                                                ...
                                                <input id="building" type="text" name="building" class="form-control" value="{{ $company->building }}" placeholder="City" maxlength="100">
                                                <div class="invalid-msg2"> </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group position-relative">
                                                ...
                                                <div class="invalid-msg2"> </div>
                                                <p class="{{ $checklist && $checklist->country == 0 ? 'alert alert-warning p-1 mt-2' : '' }}">
                                                    <small>{{ $checklist && $checklist->country == 0 ? 'Registration country is inaccurate.' : '' }}</small> 
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group position-relative">
                                                ...
                                                <input id="pobox" type="text" name="pobox" class="form-control" value="{{ $company->pobox }}" placeholder="PO Box No" maxlength="100">
                                                <div class="invalid-msg2"> </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-group position-relative">
                                                    ...
                                                    <input id="domain" type="text" name="domain" class="form-control website" value="{{ $company->domain }}" placeholder="eg:- dialectb2b.com" maxlength="100">
                                                    <div class="invalid-msg2"> </div>
                                                </div>
                                                <div class="form-group position-relative">
                                    ...
                                    <div class="col-md-4">
                                        <div class="document-upload">
                                            ...
                                            <p class="{{ $checklist && $checklist->document_type == 0 ? 'alert alert-warning p-1 mt-2' : '' }}">
                                                <small>{{ $checklist && $checklist->document_type == 0 ? "Submitted document doesn't confirmed as CR." : '' }}</small> 
                                            </p>
                                            ...
                                            <div class="form-group position-relative">
                                                ...
                                                <input id="document_no" type="text" name="document_no" class="form-control" value="{{ $company->document->doc_number ?? '' }}" placeholder="Document No" maxlength="100">
                                                <div class="invalid-msg2"> </div>
                                                <p class="{{ $checklist && $checklist->document_no == 0 ? 'alert alert-warning p-1 mt-2' : '' }}">
                                                    <small>{{ $checklist && $checklist->document_no == 0 ? "Document number doesn't match CR." : '' }}</small> 
                                                </p>
                                            </div>
                                            <div class="form-group position-relative mb-4">
                                                ...
                                                <div class="invalid-msg2"> </div>
                                                <p class="{{ $checklist && $checklist->expiry_date == 0 ? 'alert alert-warning p-1 mt-2' : '' }}">
                                                    <small>{{ $checklist && $checklist->expiry_date == 0 ? "Document expiry doesn't match CR." : '' }}</small> 
                                                </p>
                                            </div>
