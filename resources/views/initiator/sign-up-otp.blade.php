                ...
                <section class="reg-content-main">
                    ...
                    <section class="reg-content-sec">
                        <div class="signup-fields d-flex justify-content-center">
                            <div class="email-otp">
                                <h3>An OTP has been sent to your  Registered email. Please enter the OTP below</h3>
                                <span>We've send you the verification code on <a href="#" id="email"></a></span>
