                        ...
                        <div class="signup-fields">
                            ...
                            <div class="row">
                                <div class="col-md-12 declration-content">
                                    <h2 class="mb-4">To complete the account registration process, you are requested to review the Registration Application Form.</h2>

                                    
                                    <ul class="decl-ul-list">
                                        <li>Review Form: You receive a Registration Application Form that needs to be reviewed.</li>
                                        <li>Edit if Necessary: If there are any mistakes or changes needed, you can click 'Edit' to make adjustments.</li>
                                        <li>Agree to Terms: Once the form looks good, you agree to the Terms and Conditions.</li>
                                        <li>Download Form: The form is automatically downloaded for you.</li>
                                        <li>Print and Sign: Print the form, sign it, and get it stamped by an authorized representative.</li>
                                        <li>Upload Signed Form: Scan or take a photo of the signed form and upload it.</li>
                                        <li>Confirm Submission: You'll get a pop-up asking if you're sure about final submission. Click 'Yes, I Am Sure!' to submit or 'No, Cancel It!'.</li>
                                    ...
                                    <table class="table table-bordered reg-info-tbl">
                                        <tbody>
                                          ...
                                          <tr>
                                            ...
                                            <td>{{ $company->address }}, {{ $company->zone }}, {{ $company->street }}, {{ $company->building }}
                                                @if ($company->unit && $company->pobox)
                                                    , {{ $company->unit }}, {{ $company->pobox }}
                                                @elseif ($company->unit)
                                                    , {{ $company->unit }}
                                                @elseif ($company->pobox)
                                                    , {{ $company->pobox }}
                                                @endif
                                            </td>
                                          </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <p class="{{ $checklist && $checklist->declaration == 0 ? 'alert alert-warning p-1 mt-2' : '' }}">
                                        <small>{{ $checklist && $checklist->declaration == 0 ? 'Uploaded declaration not valid.' : '' }}</small> 
                                    </p>
                                    <p class="{{ $checklist && $checklist->declaration_seal == 0 ? 'alert alert-warning p-1 mt-2' : '' }}">
                                        <small>{{ $checklist && $checklist->declaration_seal == 0 ? 'Check the company seal on the declaration.' : '' }}</small> 
                                    </p>
                                    <p class="{{ $checklist && $checklist->declaration_signature == 0 ? 'alert alert-warning p-1 mt-2' : '' }}">
                                        <small>{{ $checklist && $checklist->declaration_signature == 0 ? 'Ensure a clear signature on the declaration.' : '' }}</small> 
                                    </p>
                                </div>
                            </div>
                        </div>
