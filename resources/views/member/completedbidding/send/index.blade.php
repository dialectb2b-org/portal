                ...
                <div class="bid-inbox">
                    ...
                    <div class="d-flex w-100 justify-content-between b-bottom">
                        ...
                        <ul class="nav nav-tabs tab mb-2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link tablinks3 active" href="{{ route('member.completedBidding.send') }}">Sent</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link tablinks3" href="{{ route('member.completedBidding.received') }}">Received</a>
                            </li>
                        </ul>
                        <!-- Tabs navs -->
                    </div>
                    <div class="tabcontent3" id="sent" style="display: block;">
                        <div id="send-list" class="list-group">
                            @forelse($enquiries as $key => $enquiry)
                                <a href="{{ route('procurement.completedBidding.send',$enquiry->reference_no) }}" class="list-group-item list-group-item-action flex-column align-items-start enquiry_item">
...
<script>
    ...
    function loadReviewSendList(){
        var fetchSendItemsAction = "{{ route('member.completedBidding.fetchAllSendEnquiries') }}";
