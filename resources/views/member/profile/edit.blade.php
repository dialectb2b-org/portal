    ...
    <section class="container-fluid pleft-77">
        <div class="px-4 py-3">
            <div class="sub-plans-head">
                <h1><a href="{{ route('member.profile') }}" class="back-btn"></a>Edit Profile</h1>
            </div>
            <form action="{{ route('member.updateProfile',$user->id) }}" method="post">
                @csrf
                @method('PUT')
...
<script>
    $(document).ready(function() {
        ...
        $('#upload').change(function() {
            var uploadAction = '/member/update-profile-pic';
