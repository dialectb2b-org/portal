...
class SalesProfileController extends Controller
{
    ...
    public function index(){
        ...
        return view('sales.profile.index',compact('user','company','package'));
    }
    ...
    public function edit(){
      ...
      return view('sales.profile.edit',compact('user','company','country'));
  }
      ...
      public function update(Request $request,$id){
        ...
        try{
            ...
            DB::commit();                
            return redirect()->route('sales.dashboard')->with('success','updated!');
        } catch (\Exception $e) {
            DB::rollback();
            return redirect()->route('sales.dashboard')->with('error','Something went wrong!');
        }
    }
