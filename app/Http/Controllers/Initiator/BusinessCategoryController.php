    ...
    public function addActivity(Request $request){
        ...
        try {
            ...
            if($activity > 3){
                return response()->json([
                    'status' => false,
                    'message' => 'Exceeded maximum no of categories!<br>During registration, the maximum number of categories is limited to 4 as privileged. After successful user activation, you can add additional business categories.'
                ], 422);
            }
