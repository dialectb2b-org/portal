...
class ProDraftController extends Controller
{
    ...
    public function index($id = null){
        ...
        $drafts = Enquiry::where(['company_id' => $company_id, 'from_id' =>$user_id, 'is_draft' => 1 ])->orderBy('updated_at','desc')->get();
        $selected_draft = null;
        ...
        return view('procurement.draft.index',compact('drafts','selected_draft'));
    }
