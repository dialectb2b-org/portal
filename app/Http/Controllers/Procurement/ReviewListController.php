...
class ReviewListController extends Controller
{
    ...
    public function send(Request $request, $ref = null){
        ...
        $enquiries = $query->shared()->notCompleted()->orderBy('updated_at','DESC')->get();
        ...
        return view('procurement.reviewlist.send.index',compact('enquiries','selected_enquiry'));
    }
  ...
  public function fetchEnquiry(Request $request){
    ...
    public function received(Request $request, $ref = null){
      ...
      return view('procurement.reviewlist.received.index',compact('enquiries','selected_enquiry'));
    }
      ...
      try{
          ...
          PortalTodo::create([
                ...
                'message' => 'Review Completed',
                 'action_url' => url('member/review-list/send/'.$encryptedRefNo) 
            ]);   
